      ...
      content: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: SimpleWebVideoPlayer(videoPath: 'zombies_demo.mp4'),
          ),
          Padding(
            padding: const EdgeInsets.all(16.0),
            child: MarkdownBody(
...
over the course of the semester, culminating in a 4-week final project to build a game using the engine. 
