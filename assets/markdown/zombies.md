...
Finally, I implemented a layered sprite system, allowing for more complex character animations and visual effects, such
as separate layers for the body and head which could be animated independently.
...
>
> 
> #### Everything together - player running and swinging a sword
...
the player and zombies have separate layers for the legs, body and head, allowing for independent animation of each
layer.
...
I also implemented a simple enchanting system, where the player enchant their weapon which would apply visual effect and
a weapon damage upgrade. The visual effect was implemented by using minecraft's enchanting glint texture and mimicking
the shader effect by using a scrolling texture overlay with additive blending, which created a similar shimmering effect to the one seen in Minecraft.  
